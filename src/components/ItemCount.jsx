...
function ItemCount({stock, agrega,id}) {
  ...
  return (
    <div>
      ...
      { controlStock===0? <p className="mt-2 text-cyan-100 bg-blue-500 text-xl px-2.5 py-1.5 text-center">SIN STOCK</p>:
      <div>
                  <p className="mt-2 text-white bg-blue-500 font-medium rounded-lg text-xl px-2.5 py-1.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cantidad en stock {controlStock}</p>
