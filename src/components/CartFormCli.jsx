                ...
                <form onSubmit={handleSubmit(generarOrden)}>
                    <div className="flex flex-col m-auto items-center justify-around bg-green-200  shadow-2xl  flex-wrap w-1/2 font-mono"> 
                        <div className="flex justify-center flex-col " onChange={handleInputChange}>
                            ...
                            <input type="email" placeholder="Email" className="m-1 border-slate-400 border-solid border-2" {...register("Email", { required: true, maxLength: 30 })} />
                        </div>
                    ...
                    <div className="flex flex-col mt-4 m-auto items-center justify-around bg-green-200  shadow-2xl  flex-wrap w-1/2 font-mono">
